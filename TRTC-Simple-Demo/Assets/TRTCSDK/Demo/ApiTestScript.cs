...
{
    public class ApiTestScript : MonoBehaviour, ITRTCCloudCallback, ITRTCVideoRenderCallback,
        ITRTCAudioFrameCallback
    {
        ...
        public void onRecvCustomCmdMsg(string userId, int cmdID, int seq, byte[] message, int messageSize)
        {
            mainSyncContext.Post((object state) =>
            {
                ...
                lblCallbakLog.text += Environment.NewLine +
                                      String.Format("onRecvCustomCmdMsg {0}, {1} ,{2}", userId, cmdID, msg);
            }, "");
        }
        ...
        public void onMissCustomCmdMsg(string userId, int cmdID, int errCode, int missed)
        {
            mainSyncContext.Post(
                ...
                {
                    lblCallbakLog.text +=
                        Environment.NewLine + String.Format("onMissCustomCmdMsg {0}, {1}", userId, cmdID);
                }, "");
        }
        ...
        public void onWarning(TXLiteAVWarning warningCode, String warningMsg, IntPtr arg)
        {
            mainSyncContext.Post(
                ...
                {
                    lblCallbakLog.text +=
                        Environment.NewLine + String.Format("onWarning {0}, {1}", warningCode, warningMsg);
                }, "");
        }
        ...
        public void onRemoteUserLeaveRoom(String userId, int reason)
        {
            mainSyncContext.Post(
                ...
                {
                    lblCallbakLog.text += Environment.NewLine +
                                          String.Format("onRemoteUserLeaveRoom {0}, {1}", userId, reason);
                }, "");
        }
        ...
        public void onUserVideoAvailable(String userId, bool available)
        {
            ...
            {
                lblCallbakLog.text += Environment.NewLine +
                                      String.Format("onUserVideoAvailable {0}, {1}", userId, available);
        ...
        public void onUserSubStreamAvailable(string userId, bool available)
        {
            mainSyncContext.Post(
                ...
                {
                    lblCallbakLog.text += Environment.NewLine +
                                          String.Format("onUserSubStreamAvailable {0}, {1}", userId, available);
                }, "");
        }
        ...
        public void onUserAudioAvailable(String userId, bool available)
        {
            mainSyncContext.Post(
                ...
                {
                    lblCallbakLog.text += Environment.NewLine +
                                          String.Format("onUserAudioAvailable {0}, {1}", userId, available);
                }, "");
        }
        ...
        public void onFirstVideoFrame(String userId, TRTCVideoStreamType streamType, int width, int height)
        {
            mainSyncContext.Post(
                (object state) =>
                {
                    lblCallbakLog.text += Environment.NewLine + String.Format("onFirstVideoFrame {0}, {1}, {2}, {3}",
                        userId, streamType, width, height);
                }, "");
        }
        ...
        public void onSendFirstLocalVideoFrame(TRTCVideoStreamType streamType)
        {
            mainSyncContext.Post(
                ...
                {
                    lblCallbakLog.text +=
                        Environment.NewLine + String.Format("onSendFirstLocalVideoFrame {0}", streamType);
                }, "");
        }
        ...
        {
            mainSyncContext.Post(
                (object state) => { lblCallbakLog.text += Environment.NewLine + String.Format("onConnectionLost"); },
                "");
        }
        ...
        {
            mainSyncContext.Post(
                (object state) => { lblCallbakLog.text += Environment.NewLine + String.Format("onTryToReconnect"); },
                "");
        }
        ...
        {
            mainSyncContext.Post(
                (object state) => { lblCallbakLog.text += Environment.NewLine + String.Format("onCameraDidReady"); },
                "");
        }
        ...
        {
            mainSyncContext.Post(
                (object state) => { lblCallbakLog.text += Environment.NewLine + String.Format("onMicDidReady"); }, "");
        }
        ...
        public void onDeviceChange(String deviceId, TRTCDeviceType type, TRTCDeviceState state)
        {
            mainSyncContext.Post(
                ...
                {
                    lblCallbakLog.text += Environment.NewLine +
                                          String.Format("onSwitchRole {0}, {1}, {2}", deviceId, type, state);
                }, "");
        }
        ...
        public void onRecvSEIMsg(String userId, Byte[] message, UInt32 msgSize)
        {
            mainSyncContext.Post((object state) =>
            {
                ...
                lblCallbakLog.text += Environment.NewLine +
                                      String.Format("onRecvSEIMsg {0}, {1}, {2}", userId, seiMessage, msgSize);
            }, "");
        }
        ...
        public void onStartPublishing(int err, string errMsg)
        {
            mainSyncContext.Post(
                ...
                {
                    lblCallbakLog.text +=
                        Environment.NewLine + String.Format("onStartPublishing {0}, {1}", err, errMsg);
                }, "");
        }
        ...
        public void onStartPublishCDNStream(int err, string errMsg)
        {
            ...
            {
                lblCallbakLog.text += Environment.NewLine +
                                      String.Format("onStartPublishCDNStream {0}, {1}", err, errMsg);
            }, "");
        }
        ...
        public void onStopPublishCDNStream(int err, string errMsg)
        {
            mainSyncContext.Post(
                ...
                {
                    lblCallbakLog.text += Environment.NewLine +
                                          String.Format("onStopPublishCDNStream {0}, {1}", err, errMsg);
                }, "");
        }
        ...
        public void onConnectOtherRoom(string userId, TXLiteAVError errCode, string errMsg)
        {
            ...
            {
                lblCallbakLog.text += Environment.NewLine +
                                      String.Format("onConnectOtherRoom {0}, {1}, {2}", userId, errCode, errMsg);
            }, "");
        }
        ...
        public void onDisconnectOtherRoom(TXLiteAVError errCode, string errMsg)
        {
            ...
            {
                lblCallbakLog.text +=
                    Environment.NewLine + String.Format("onDisconnectOtherRoom {0}, {1}", errCode, errMsg);
            }, "");
        }
        ...
        public void onSpeedTest(TRTCSpeedTestResult currentResult, int finishedCount, int totalCount)
        {
            mainSyncContext.Post((object state) =>
            {
                lblCallbakLog.text += Environment.NewLine + String.Format("onSpeedTest {0}, {1} ,{2}",
                    currentResult.upLostRate, finishedCount, totalCount);
            }, "");
        }
        ...
        public void onAudioDeviceCaptureVolumeChanged(int volume, bool muted)
        {
            ...
            {
                lblCallbakLog.text += Environment.NewLine +
                                      String.Format("onAudioDeviceCaptureVolumeChanged {0} , {1}", volume, muted);
            }, "");
        }
        ...
        public void onAudioDevicePlayoutVolumeChanged(int volume, bool muted)
        {
            ...
            {
                lblCallbakLog.text += Environment.NewLine +
                                      String.Format("onAudioDevicePlayoutVolumeChanged {0} , {1}", volume, muted);
            }, "");
        }
            ...
            int height, TRTCVideoPixelFormat format)
        {
            mainSyncContext.Post(
                ...
                {
                    lblCallbakLog.text +=
                        Environment.NewLine + String.Format("onSnapshotComplete {0} , {1}", userId, type);
                }, "");
        }
        ...
        public void onSetMixTranscodingConfig(int errCode, String errMsg)
        {
            ...
            {
                lblCallbakLog.text += Environment.NewLine +
                                      String.Format("onSetMixTranscodingConfig {0} , {1}", errCode, errMsg);
            }, "");
        }
        ...
        public void onLocalProcessedAudioFrame(TRTCAudioFrame frame)
        {
            ...
            mainSyncContext.Post((object state) =>
            {
                lblCallbakLog.text += Environment.NewLine + String.Format(
                    "onLocalProcessedAudioFrame channel={0}, audioFormat={1}, sampleRate={2}, timestamp={3}",
                    frame.channel, frame.audioFormat, frame.sampleRate, frame.timestamp);
            }, "");
        }
        ...
        class MusicPlayObserver : ITXMusicPlayObserver
        {
            ...
            public MusicPlayObserver(Text log, SynchronizationContext context)
            {
                lbLog = log;
                mainContext = context;
                observerId = new System.Random().Next();
            }
            ...
            public void onStart(int id, int errCode)
            {
                ...
                {
                    lbLog.text += Environment.NewLine + String.Format("ITXMusicPlayObserver {0} onStart {1}, {2}",
                        observerId, id, errCode);
                }, "");
            }
            ...
            public void onPlayProgress(int id, long curPtsMS, long durationMS)
            {
                mainContext.Post(
                    (object state) =>
                    {
                        lbLog.text = Environment.NewLine +
                                     String.Format("ITXMusicPlayObserver {0}  onPlayProgress {1}, {2} ,{3}", observerId,
                                         id,
                                         durationMS, curPtsMS);
                    }, "");
            }
            ...
            public void onComplete(int id, int errCode)
            {
                mainContext.Post(
                    (object state) =>
                    {
                        lbLog.text += Environment.NewLine + String.Format(
                            "ITXMusicPlayObserver {0}  onComplete {1}, {2}",
                            observerId, id, errCode);
                    }, "");
            }
        }
        ...
        private void createBtns()
        {
            ...
            var enterRoomBtn = transform.Find("Left/roomPanel/btnLogin").gameObject.GetComponent<Button>();
        ...
        public void GetVideoRenderDataClick()
        {
            ...
            lblBtnClickLog.text += Environment.NewLine + string.Format("width = {0}, height={1}, length={2}，data={3}",
                width, height, length, mNativeTextureData.ToString());
        }
        ...
        public void enterRoomClick()
        {
            ...
            lblBtnClickLog.text += "Scene:" + scene + ", Role:" + trtcParams.role + ", Qos-Prefer:" +
                                   qosParams.preference + ", Qos-CtrlMode:" + qosParams.controlMode;
        }
        ...
        public void sendSEIMsg()
        {
            ...
            lblBtnClickLog.text += Environment.NewLine + "sendSEIMsg = " + result.ToString() + "   ,seiSize=" +
                                   seiSize.ToString();
        }
        ...
        public void sendCustomCmdMsgClick()
        {
            ...
            bool result = mTRTCCloud.sendCustomCmdMsg(01, System.Text.Encoding.Default.GetBytes(cmdMsg),
        ...
        {
            mTXAudioEffectManager.setMusicObserver(13, new MusicPlayObserver(lblCallbakLog, mainSyncContext));
            AudioMusicParam musicParam = new AudioMusicParam();
            musicParam.id = 13;
            musicParam.publish = true;
            musicParam.loopCount = 20;
            musicParam.startTimeMS = 10;
            musicParam.endTimeMS = 30000;
            musicParam.path =
        ...
        public void setSystemVolumeTypeMedia()
        {
            ...
            lblBtnClickLog.text += Environment.NewLine + " setSystemVolumeType TXSystemVolumeTypeMedia result=" +
                                   result.ToString();
        }
        ...
        public void setSystemVolumeTypeVOIP()
        {
            ...
            lblBtnClickLog.text += Environment.NewLine + " setSystemVolumeType TXSystemVolumeTypeVOIP result=" +
                                   result.ToString();
        }
        ...
        public void setSystemVolumeTypeAuto()
        {
            ...
            lblBtnClickLog.text += Environment.NewLine + " setSystemVolumeType TXSystemVolumeTypeAuto result=" +
                                   result.ToString();
        }
        ...
        public void setWaterMarkClick()
        {
            ...
            mTRTCCloud.setWaterMark(TRTCVideoStreamType.TRTCVideoStreamTypeBig, mTestPath,
                TRTCWaterMarkSrcType.TRTCWaterMarkSrcTypeFile, 1000, 1000, 0, 0, 0.5f);
        }
        ...
        {
            mTRTCCloud.startSpeedTest(GenerateTestUserSig.SDKAPPID, DataManager.GetInstance().GetUserID(),
                GenerateTestUserSig.GetInstance().GenTestUserSig(DataManager.GetInstance().GetUserID()));
        }
