mergeInto(LibraryManager.library, {
  TRTCUnityAddOtherCallback: function( instance,
  ...
  TRTCUnityAddCallback: function( instance,
        on_error_handler,
        on_warning_handler,
  ...
  TRTCUnityAddScreenCaptureCallback: function( instance,
  ...
  TRTCUnitySetAudioFrameCallback: function( instance,
  ...
  TRTCUnityEnterRoom: function( instance,  sdk_app_id,  user_id,  user_sig,  room_id,
             str_room_id,  role,  stream_id,  user_define_record_id,  private_map_key,  business_info,  scene) {
      TRTCUnityEnterRoom( instance,  sdk_app_id,  Pointer_stringify(user_id),  Pointer_stringify(user_sig),  room_id,
             Pointer_stringify(str_room_id),  role,  Pointer_stringify(stream_id),  Pointer_stringify(user_define_record_id),  Pointer_stringify(private_map_key),  Pointer_stringify(business_info),  scene);
  },
  ...
  TRTCUnitySetDefaultStreamRecvMode: function(instance, autoRecvAudio,  autoRecvVideo) {

  },

  TRTCUnitySwitchRoom: function(instance, roomId, strRoomId, userSig, privateMapKey) {
    TRTCUnitySwitchRoom(instance, roomId, Pointer_stringify(strRoomId), Pointer_stringify(userSig), Pointer_stringify(privateMapKey));
  },
  ...
  TRTCUnitySetMixTranscodingConfig: function(instance, mode, appId, bizId, videoWidth, videoHeight, videoBitrate, videoFramerate,
   videoGOP, backgroundColor,  backgroundImage, audioSampleRate, audioBitrate, audioChannels, mixUsersArraySize,  streamId,  mixUsersArray) {
  ...
  TRTCUnityGetVideoRenderData: function(instance, userId, rotation,  width,  height,  length, isNeedDestroy) {
  ...
  TRTCUnityMuteAllRemoteVideoStreams: function(instance,  mute) {
   ...
   TRTCUnitySetVideoEncoderParam: function(instance,
       video_resolution,
       res_mode,
      video_fps,
      video_bitrate,
  ...
  TRTCUnitySetNetworkQosParam: function(instance,
       preference,
       control_mode) {
  ...
  TRTCUnitySetRemoteRenderParams: function(instance,  userId,  streamType,  fillMode,  mirrorType,  rotation) {

  },
    
  TRTCUnityEnableSmallVideoStream: function(instance,  enable, smallVideoParam) {
  ...
  TRTCUnitySetBeautyStyle: function(instance,  style,  beauty,  white,  ruddiness) {

  },
        
  TRTCUnitySetWaterMark: function(instance,  streamType,  srcData,  srcType,  nWidth,  nHeight,  xOffset,  yOffset,  fWidthRatio) {
  ...
  TRTCUnityStartLocalRecording: function(instance,  filePath,  recordType,  erval) {
  ...
  TRTCUnitySendCustomVideoData: function(instance,
       video_format,
       buffer_type,
      data,
       texture_id,
  ...
  TRTCUnitySendCustomAudioData: function(instance,
       audio_format,
       data,
      length,
      sample_rate,
  ...
  TRTCUnitySetLocalVideoRenderCallback: function(instance,  pixel_format,
       buffer_type, on_render_video_frame_handler) {

  },
  
  TRTCUnitySetRemoteVideoRenderCallback: function(instance,  user_id,
       pixel_format,  buffer_type, on_render_video_frame_handler) {
  ...
  TRTCUnitySendCustomCmdMsg: function(instance,  cmdId,  data,  dataSize,  reliable,  ordered) {
  ...
  TRTCUnityStartScreenCapture: function(instance,
       stream_type,
       video_resolution,
       res_mode,
      video_fps,
  ...
  TRTCUnityGetScreenCaptureSourceCount: function(instance,  thumbnail_width,  thumbnail_height) {

  },
    
  TRTCUnitySelectScreenCaptureTarget: function(instance,  type, source_id,  source_name,
         capture_left,  capture_top,  capture_right,  capture_bottom,
         enable_capture_mouse,  enable_highlight,  enable_high_performance,  highlight_color,  highlight_Width) {

  },

    
  TRTCUnitySetSubStreamEncoderParam: function(instance,
       video_resolution,
       res_mode,
      video_fps,
      video_bitrate,
  ...
  TRTCUnitySetMusicObserver: function(instance, musicId, onStart, onPlayProgress, onComplete) {},
